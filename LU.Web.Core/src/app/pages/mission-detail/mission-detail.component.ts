...
import { AccordionTabComponent } from '../../shared';
...
export class MissionDetailComponent implements OnInit {
  ...
  public changeLinkedTab(tab: AccordionTabComponent) {
    if (tab) {
      // validate
  ...
  ngOnInit() {
    ...
    this.model.allowPoints = false;
    this.model.canDoubleXP = false;
    this.model.showNotificationsOnRelease = false;
  }
